...
// AI Polish actions
const aiActions = [
  { id: 'fix_grammar', label: '纠正语法', icon: '✓' },
  { id: 'improve_style', label: '润色文风', icon: '✨' },
  { id: 'expand', label: '扩展内容', icon: '📝' },
  { id: 'shorten', label: '精简内容', icon: '📋' },
  { id: 'remove_fillers', label: '去语气词', icon: '🧹' },
  { id: 'translate_en', label: '翻译英文', icon: '🇬🇧' },
  { id: 'translate_zh', label: '翻译中文', icon: '🇨🇳' },
]
